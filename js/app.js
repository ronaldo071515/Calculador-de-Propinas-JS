...
function mostrarPlatillos(platillos) {
    ...
    platillos.forEach( platillo => {
        ...
        inputCantidad.onchange = function() {
            ...
            agregarPlatillo({...platillo, cantidad});//Convertirlo en objeto
        };
...
function agregarPlatillo(producto) {
    ...
    if ( producto.cantidad > 0 ) {
        ...
        //Comprueba si el elemento ya exista en el array
        if( pedido.some( articulo => articulo.id === producto.id ) ) {
            ...
            //El articulo no existe lo agg al array de pedido
            cliente.pedido = [...pedido, producto];
        }
        
    } else {
        //Eliminar elemntos cuando la cantidad sea 0 cero
...
function calcularPropina() {
    ...
    //Selcciona el radio button con la propina del cliente
...
function mostrarTotalHTML(subtotal, total, propina) {
    ...
    totalParrafo.classList.add('fs-4', 'fw-bold', 'mt-2', 'text-danger');
